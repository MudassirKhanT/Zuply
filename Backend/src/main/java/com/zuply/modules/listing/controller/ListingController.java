...
public class ListingController {
    ...
    public ResponseEntity<ApiResponse<ListingResponse>> generateListing(
        ...
        try {
            ...
            if (msg.contains("All Gemini models exhausted") || msg.contains("quota")
                    || msg.contains("429") || msg.toLowerCase().contains("rate limit")) {
                return ResponseEntity.status(429)
                        .body(ApiResponse.failure("AI_QUOTA_EXCEEDED"));
            }
    ...
    public ResponseEntity<ApiResponse<ListingResponse>> saveExtraImages(
        ...
        try {
            ...
            return ResponseEntity.ok(ApiResponse.success("Images saved", response));
        } catch (Exception e) {
