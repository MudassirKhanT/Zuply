    ...
    public ResponseEntity<ApiResponse<ProductDto>> updateStock(
        ...
        try {
            ...
            if (stock == null || stock < 0)
                return ResponseEntity.status(400).body(ApiResponse.failure("Stock must be 0 or greater"));
            ProductDto updated = productService.updateStock(id, stock, seller.getId());
