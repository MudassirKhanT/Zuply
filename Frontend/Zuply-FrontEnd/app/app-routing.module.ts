...
const routes: Routes = [
  ...
  { path: 'seller/upload',                 component: UploadComponent,          canActivate: [AuthGuard] },
  { path: 'seller/listing-preview/:imageId', component: ListingPreviewComponent, canActivate: [AuthGuard] },
  ...
  { path: 'admin/sellers',   component: AdminSellersComponent,   canActivate: [AuthGuard] },
