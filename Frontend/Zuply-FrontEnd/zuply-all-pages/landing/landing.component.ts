...
export class LandingComponent implements OnInit, OnDestroy {
  ...
  counters = [
    ...
    { label: 'Cities Covered',   target: 100,    value: 0, suffix: '+' }
  ];
  ...
  goToRegisterAsSeller(): void {
    // If already logged in, send to the become-a-seller info page
    // If not logged in, go straight to register with SELLER pre-selected
    if (this.isLoggedIn) {
