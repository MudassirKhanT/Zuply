...
export class DashboardComponent implements OnInit {
  ...
  goToAllProducts(): void      { this.router.navigate(['/seller/products'], { queryParams: { filter: 'all'      } }); }
  goToAllOrders(): void        { this.router.navigate(['/seller/orders'],   { queryParams: { filter: 'all'      } }); }
  goToPendingOrders(): void    { this.router.navigate(['/seller/orders'],   { queryParams: { filter: 'pending'  } }); }
  goToApprovedProducts(): void { this.router.navigate(['/seller/products'], { queryParams: { filter: 'approved' } }); }
